/***************************************************************************
 *     @file: tutubarão_segundo_teste.c                                    *
 *   @author: Gustavo Rosatto Silva                                        *
 * @objective: automatizar o movimento do tubarão/ automate shark movement *
 ***************************************************************************/
...
void media_execucao(char mapa_oceano[altura][largura]){

    float tempos_de_busca[3];
    
    int bad, tempo_de_busca;

    char auxiliar, chave_de_movimento_tubarao;
    ...
    for (bad = 0; bad < 10; ++bad){
        ...
        tempos_de_busca[0] = tempos_de_busca[0] + tempo_de_busca; 
    ...
    for (bad = 0; bad < 10; ++bad){
        ...
        tempos_de_busca[1] = tempos_de_busca[1] + tempo_de_busca; 
    ...
    for (bad = 0; bad < 10; ++bad){
        ...
        while(1 == 1){
            ...
            auxiliar = gerador_de_cordenada(chave_de_movimento_tubarao);
        ...
        tempos_de_busca[2] = tempos_de_busca[2] + tempo_de_busca; 

    }

    printf("Tempo médio de busca sem se mover: %f\nTempo médio de busca IA tubarão: %f\nTempo médio de busca tubrão se movimentando aleatório: %f\n", tempos_de_busca[1]/10,tempos_de_busca[0]/10,tempos_de_busca[2]/10);
